...
var SvgIcon = React92.forwardRef(function SvgIcon2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSvgIcon"
  });
  ...
  const hasSvgAsChild = React92.isValidElement(children) && children.type === "svg";
  const ownerState = _extends({}, props, {
    color,
    component,
    fontSize,
...
function createSvgIcon(path, displayName) {
  ...
  return React93.memo(React93.forwardRef(Component));
}
